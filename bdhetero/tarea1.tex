...
\begin{eqnarray*}
 T_1 & \asig & \sigma_{(\text{Nombre}=\text{``Luis Pérez''})}(\text{BEBEDOR}) \\
 T_2 & \asig & \pi_{\text{CodFS}}(T_1 \text{ Join } \text{FRECUENTA}) \\ % FS frecuentadas por luis
 T_3 & \asig & \pi_{\text{CI,CodFS}}(\text{BEBEDOR} \times \text{FUENTES\_SODA}) \\
 \text{NO\_FREC} & \asig & T_3 - \text{FRECUENTA} \\ % NO_FRECUENTA
 T_4 & \asig & \pi_{\text{CI}}(T_2 \text{ Join } \text{NO\_FREC}) \\ % CI de los que no frecuentan alguna FS frecuentada por luis
...
\begin{eqnarray*}
 ...
 T_4 & \asig & \pi_{\text{CI}}(T_2 \text{ Join } \text{NO\_FREC}) \\ % CI de los que no frecuentan alguna FS frecuentada por luis
 T_5 & \asig & \pi_{\text{CI}}(BEBEDOR) - T_4 \\
 T_6 & \asig & \pi_{\text{CodFS}}(T_1 \text{ Join } \text{NO\_FREC}) \\ % FS no frecuentadas por luis
 T_7 & \asig & \pi_{\text{CI}}(T_6 \text{ Join } \text{FRECUENTA}) \\ % CI de los que frecuentan alguna FS no frecuentada por luis
 T_8 & \asig & T_5 - T_7 \\
\end{eqnarray*}
...
\begin{eqnarray*}
 T_1 & \asig & \pi_{\text{CI,CodFS}}(\text{VENDE} \text{ Join } \text{GUSTA}) \\
 T_2 & \asig & \pi_{\text{CI,CodFS}}(\text{VENDE} \text{ Join } \text{NO\_GUSTA}) \\
 T_3 & \asig & T_1 - T_2 \\
 T_4 & \asig & T_3 \text{ Join } \text{NO\_FRECUENTA} \\
 T_5 & \asig & (\text{BEBEDOR} \times \text{FUENTES\_SODA} - T_3) \text{ Join } \text{FRECUENTA} \\
 T_6 & \asig & \pi_{\text{CI}}(\text{BEBEDOR}) - \pi_{\text{CI}}(T_4) - \pi_{\text{CI}}(T_5) \\
\end{eqnarray*}
