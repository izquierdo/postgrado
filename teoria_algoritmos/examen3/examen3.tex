...
Para decidir cuál es el siguiente nodo a expandir en un momento dado se toman todos los
sucesores no visitados del nodo actual y se elige alguno que tenga la mínima cota
inferior según la función de acotamiento. En caso de no existir ninguno, se hace backtracking.
