...
\begin{abstract}
Una Arquitectura Orientada a Servicios típica consiste de dos capas principales.
...
lógica. La infraestructura adopta la solución Local-As-View en la cual la
