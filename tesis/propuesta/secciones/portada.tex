...
combinatorio. En este trabajo se propone una infraestructura basada en
la lógica proposicional para resolver
eficientemente el problema de instanciación. La infraestructura adopta el enfoque de definición denominado Local-As-View en el cual la
...
que también se puede verificar que es correcta y completa dado que, estando basada en la lógica, es
