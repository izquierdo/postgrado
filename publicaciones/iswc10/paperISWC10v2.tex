...
of the theory encodes a valid rewriting; the theory can be con-
structed in polynomial time from the instance of the SSP. All valid
...
c2d~\cite{c2d} and Relsat~\cite{relsat}; off-the-  seft SAT solvers
...
that  implement non-chronological backtacking via clause learning,
...
$2.6\times 10^8$ models. ÊThe time to enumerate all models is about 147 hours. 
